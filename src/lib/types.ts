...
export interface Question {
  ...
  visualData?: { labels?: string[]; values?: number[]; points?: [number, number][]; caption?: string };
  structuralFingerprint: string;
}

export type PublicQuestion = Omit<Question, "correctAnswer" | "solution" | "distractorReasoning" | "structuralFingerprint">;
export interface BlueprintSlot { position: number; axis: Axis; skill: Skill; difficulty: 1 | 2 | 3 | 4 | 5; resourceType: ResourceType; }
